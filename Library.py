...
class Library:
    ...
    def add_book(book):
        ...
        print(f"Book {self.title} is added")
    def remove_book(self,isbn):
        ...
        if book_to_remove:
            ...
            print(f"Book {book_to_remove} is remove from Library")
    def display_books(self):
        if not self.books:
            ...
            for book in self.books:
                book.display()
class specialLibrary(Library):  # inheritence inherted from Library.
    def add_book(self,book):  # overriding the add_book method 
        self.books.append(book)
        print(f"specialLibrary Book  {self.title} is added")
